		...
		<b-row>
						...
						<b-col lg="12">
							...
							>
								...
								<div v-if="questionListLength < 10">
									<b-list-group-item
										v-for="index in 10 - questionListLength"
										:key="index + questionListLength"
									>
										<p></p>
									</b-list-group-item>
								</div>
			...
			<b-col lg="8">
				<b-container>
					...
					<b-row
						align-h="center"
						@click="changeShowSessionStat()"
						style="cursor: pointer;"
					>
						<b-col cols="2"> </b-col>
						<b-col cols="8">
							<h4 style="text-align: center;">
								{{ getLocale.sessionStats }}
							</h4>
						</b-col>
						...
						<b-col>
							...
							>
								{{ getLocale.incorrect
									...
									v-b-tooltip.hover
									:title="getLocale.incorrectTooltip"
									>{{
										sessionInformation.otherUserIncorrect
									}}%</span
								>
					...
					<b-row
						align-h="center"
						@click="changeShowQuestionStat"
						style="cursor: pointer;"
					>
						<b-col cols="2"> </b-col>
						<b-col cols="8">
							<h4 style="text-align: center;">
								{{ getLocale.questionStats }}
							</h4>
						</b-col>
						<b-col cols="2" style="text-align: right;">
							<p>
					...
					<b-row v-show="showQuestionStat">
						...
						<b-col>
							<h6
								v-if="
									sessionInformation.questionList[
										selectedQuestion
									].otherUserCorrect !== 'notAvailable'
								"
							>
								{{ getLocale.correct
								}}{{
						...
						<b-col>
							<h6
								v-if="
									sessionInformation.questionList[
										selectedQuestion
									].otherUserIncorrect !== 'notAvailable'
								"
							>
								{{ getLocale.incorrect
								}}<span
					...
					<b-row class="mb-3">
						<b-col lg="12">
							<DisplayQuestion
								:resultInfo="getResultInformation"
...
export default {
	...
	methods: {
		...
		checkResult(index) {
			return this.sessionInformation.questionList[this.selectedQuestion]
	...
	computed: {
		...
		getAnswerList() {
			if (
				this.sessionInformation.questionList[this.selectedQuestion]
		...
		getResultInformation() {
			let response = {};
			let question = this.sessionInformation.questionList[
		...
		getCardText: function() {
			return (index) => {
				return `${this.getLocale.answer} ${index} - ${
						this.checkResult(index) === 1
