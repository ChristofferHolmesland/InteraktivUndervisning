			...
			<b-col cols="4">
				<b-row>
					<b-col>
						...
						<p>
							{{ getLocale.didntKnow }} {{ resultInfo.didntKnow }}
						</p>
						<p>
							{{ getLocale.wrong }}
				...
				<b-row align-h="around">
					<b-col cols="6">
						<b-button @click="endSession" block variant="danger">{{
							getLocale.endSessionBtn
						}}</b-button>
					</b-col>
					<b-col cols="6">
						<b-button
...
export default {
	...
	methods: {
		...
		endSession() {
			if (confirm(this.getLocale.leaveSessionBodyAdmin))
