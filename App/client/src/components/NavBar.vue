			...
			<b-collapse is-nav id="nav_collapse">
				...
				<b-navbar-nav class="ml-auto">
					...
					<b-nav-item-dropdown :text="locale.lang" right class="mr-3">
						<b-dropdown-item-button @click="localeChange($event)" :id="localeItem" :key="localeItem" v-for="localeItem in localeList"  value="{{localeItem}}">{{localeItem}}</b-dropdown-item-button>
					</b-nav-item-dropdown>
