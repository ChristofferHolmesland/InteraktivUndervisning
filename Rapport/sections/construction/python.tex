...
\begin{enumerate}
    ...
    \item If the line contains a "." it could be a property access or a function call. The possible object and property names are extracted. If an object with the given property name exists, the referenced data is returned. If the property doesn't exists, then it could either be a function 


!! Write about operators !!

!! Write about _uniqueId !!
