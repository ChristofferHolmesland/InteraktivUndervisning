\begin{titlepage}
	\noindent\begin{tabularx}{\textwidth}{ |X|>{\centering}X| }
		...
		Interactive teaching & Pages: 74 \tabularnewline % TODO legg til antall sider
		Web application & \tabularnewline
		Algorithms \& data structures & + enclosure: zip archive \tabularnewline % TODO legg til vedlegg/annet
