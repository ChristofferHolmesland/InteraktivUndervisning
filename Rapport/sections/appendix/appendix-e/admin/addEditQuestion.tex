...
\begin{figure}[H]
	\begin{subfigure}{0.70\linewidth}
		\includegraphics[width=\linewidth]{userManual/adminImages/QuestionDashboardEmpty}
		\caption{}
		\label{fig:QuestionDashboardEmpty}
	\end{subfigure}
	\begin{subfigure}{0.70\linewidth}
		\includegraphics[width=\linewidth]{userManual/adminImages/EditQuestionBasicInfo}
		\caption{}
		\label{fig:EditQuestionBasicInformation}
    \end{subfigure}
	\begin{subfigure}{0.70\linewidth}
		\includegraphics[width=\linewidth]{userManual/adminImages/EditQuestionSolution}
		\caption{}
...
\begin{figure}[H]
	\begin{subfigure}{0.70\linewidth}
		\includegraphics[width=\linewidth]{userManual/adminImages/EditQuestionImageMediaPNG}
		\caption{}
		\label{fig:EditQuestionImageMedia}
	\end{subfigure}
	\begin{subfigure}{0.70\linewidth}
		\includegraphics[width=\linewidth]{userManual/adminImages/EditQuestionGraphMedia}
		\caption{}
		\label{fig:EditQuestionGraphMedia}
    \end{subfigure}
	\begin{subfigure}{0.70\linewidth}
		\includegraphics[width=\linewidth]{userManual/adminImages/EditQuestionTablesMedia}
		\caption{}
